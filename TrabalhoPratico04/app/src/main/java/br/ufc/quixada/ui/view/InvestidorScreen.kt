package br.ufc.quixada.ui.view
...
import br.ufc.quixada.model.Investimento
...
fun InvestidorScreen(
    ...
    viewModel: InvestimentosViewModel = viewModel()
) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Investidor App", color = MaterialTheme.colorScheme.onPrimary) },
...
fun InvestimentoItem(
    ...
    Card(
        ...
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .padding(8.dp), // retirei o vertical, pra descolar o ícone

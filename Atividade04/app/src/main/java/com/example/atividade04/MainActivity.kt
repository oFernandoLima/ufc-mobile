...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nameText.text = "Fernando Lima"
        descriptionText.text = "Desenvolvedor FullStack em formaçaão."
        currentJobText.text = "Emprego Atual: Bolsista PIBITI - UFC"

        // Lista de experiências
        val experiencias = listOf(
            "Bolsista em Empreendedorismo - UFC",
            "Bolsita em Desenvolvimento Backend (BIA) - UFC"
        )
        ...
        profileImage.setOnClickListener {
            Toast.makeText(this, "Foto de perfil de Fernando Lima", Toast.LENGTH_SHORT).show()
        }
